INSERT INTO users (alias,pass,avatar) VALUES ("admin",'admin','https://38.media.tumblr.com/avatar_fdfe92b90642_128.png');
...
INSERT INTO threads (genre_id,creator_id,topic,detail) VALUES (1,1,"Best Devil May Cry Game?","Which of all the games do you think trumps all of the others and why? Personally, I like DMC3 because the mechanics are good and it was the last of its series to use the original Dante.");
